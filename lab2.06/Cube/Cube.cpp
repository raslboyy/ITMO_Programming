...
void Cube::View::operator()(Cube &cube, unsigned int to) {
  if (to == UP)
    cube.faces = {cube.faces[BACK], cube.faces[FRONT], cube.faces[LEFT], cube.faces[RIGHT], cube.faces[UP], cube.faces[DOWN]};
  else if (to == DOWN)
    cube.faces = {cube.faces[FRONT], cube.faces[BACK], cube.faces[LEFT], cube.faces[RIGHT], cube.faces[DOWN], cube.faces[UP]};
  else if (to == LEFT)
    cube.faces = {cube.faces[UP], cube.faces[DOWN], cube.faces[BACK], cube.faces[FRONT], cube.faces[LEFT], cube.faces[RIGHT]};
  else if (to == RIGHT)
