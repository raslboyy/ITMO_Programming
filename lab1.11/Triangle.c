...
{
    return len(triangle.a, triangle.b) + len(triangle.b, triangle.c) + len(triangle.c, triangle.a);
}
...
float area(struct Triangle triangle)
{
    ...
    float p = P / 2;
    return sqrt(p * (p - len(triangle.a, triangle.b)) * (p - len(triangle.b, triangle.c)) * (p - len(triangle.c, triangle.a)));
}

struct Triangle creat_from_console(){
    struct Triangle triangle;
    scanf("%f %f", &(triangle.a.x), &(triangle.a.y));
    //printf("%f %f", (triangle.a.x), (triangle.a.y));
